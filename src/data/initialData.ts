...
export const INITIAL_AUTHORS: Author[] = [
  {
    ...
    bio: 'गैजेट ग्लो के संस्थापक एवं प्रधान संपादक। 15 वर्षों से राष्ट्रीय राजनीति और तकनीक व विशेष मामलों के विशेषज्ञ।',
  ...
  },
  {
    ...
    bio: 'राजनीतिक विश्लेषण, कानूनी मामलों, फैक्ट-चेक और तकनीक रिपोर्टिंग में 10 साल का अनुभव।',
  ...
  },
  {
    ...
    bio: 'ग्राउंड जीरो रिपोर्टिंग, सामाजिक व तकनीकी मुद्दों और शिक्षा पर विशेष दृष्टि।',
...
<p>प्रशासन ने नागरिकों से अपील की है कि वे आकाशीय बिजली चमकने के दौरान खुले मैदानों और पेड़ों के नीचे जाने से बचें। बिजली निगम ने हेल्पलाइन नंबर जारी कर दिए हैं ताकि फॉल्ट की सूचना तुरंत दर्ज कराई जा सके।</p>`,
    ...
    imageCredit: 'गैजेट ग्लो / विशेष फोटो',
    ...
    views: 4820,
    likes: 312,
    seoTitle: 'हरियाणा मौसम: 12 जिलों में भारी बारिश का अलर्ट | Gadget Glow',
    ...
    seoKeywords: ['Haryana Weather', 'Haryana rain alert', 'Panipat news', 'Gadget Glow'],
  },
  {
    id: 'art-2',
...
<p>तलाशी लेने पर आरोपियों के कब्जे से 5 अवैध पिस्टल और 20 राउंड कारतूस बरामद हुए हैं। डीसीपी क्राइम ने प्रेस कॉन्फ्रेंस में बताया कि ये आरोपी मध्य प्रदेश से सस्ते दामों पर हथियार लाकर हरियाणा और दिल्ली के गैंगस्टरों को सप्लाई करते थे। अदालत में पेश कर रिमांड हासिल की जाएगी।</p>`,
    ...
    imageCredit: 'गैजेट ग्लो / पुलिस सूत्र',
    categoryId: 'cat-apradh',
    categoryName: 'अपराध',
...
<p>मार्केट कमेटी के सचिव ने बताया कि किसानों की सुविधा के लिए गेट पास और तौल की डिजिटल व्यवस्था की गई है ताकि मंडियों में अनावश्यक जाम न लगे। किसानों ने बताया कि समय पर बारिश होने के कारण इस वर्ष धान का दाना चमकदार और वजनदार है।</p>`,
    ...
    imageCredit: 'गैजेट ग्लो / कृषि प्रतिनिधि',
    categoryId: 'cat-vyapar',
    categoryName: 'व्यापार',
    subcategoryId: 'sub-karnal',
    subcategoryName: 'करनाल',
...
<p>रोहतक के छोटू राम स्टेडियम स्थित अखाड़े में ढोल-नगाड़ों और मिठाइयों के साथ विजेताओं का भव्य स्वागत किया गया। कोच ने कहा कि आगामी अंतरराष्ट्रीय प्रतियोगिताओं के लिए पहलवानों का यह प्रदर्शन मनोबल बढ़ाने वाला है।</p>`,
    ...
    imageCredit: 'खेल डेस्क / गैजेट ग्लो',
    categoryId: 'cat-khel',
    categoryName: 'खेल',
...
<p>गाड़ी में 15.6 इंच का टचस्क्रीन इंफोटेनमेंट सिस्टम, वॉयस असिस्टेंस, पैनोरमिक सनरूफ और 6 एयरबैग्स स्टैंडर्ड दिए गए हैं। कंपनी ने देश भर में 500 नए अल्ट्रा-फास्ट चार्जिंग स्टेशन स्थापित करने की घोषणा भी की है।</p>`,
    ...
    imageCredit: 'ऑटो डेस्क गैजेट ग्लो',
    categoryId: 'cat-auto',
    categoryName: 'ऑटो',
    authorId: 'auth-2',
    authorName: 'राजेश कुमार (Rajesh Kumar)',
...
export const INITIAL_VIDEOS: VideoNews[] = [
  {
    ...
    description: 'पानीपत से गैजेट ग्लो की ग्राउंड जीरो रिपोर्ट। देखिए प्रशासन की क्या हैं तैयारियां।',
    categoryId: 'cat-haryana',
    categoryName: 'हरियाणा',
    authorName: 'पूजा शर्मा',
  ...
  },
  {
    ...
    description: 'अर्थशास्त्रियों और उद्योगपतियों के साथ गैजेट ग्लो का विशेष विश्लेषण।',
    categoryId: 'cat-desh',
    categoryName: 'देश',
    authorName: 'प्रदीप सैनी',
    publishedAt: new Date(Date.now() - 1000 * 60 * 180).toISOString(),
...
export const INITIAL_ADVERTISEMENTS: Advertisement[] = [
  {
    ...
    targetUrl: 'https://gadgetglow.com',
    isActive: true,
    impressions: 12500,
    clicks: 430,
  },
...
export const INITIAL_SITE_SETTINGS: SiteSettings = {
  websiteName: 'Gadget Glow',
  tagline: 'गैजेट, टेक और डिजिटल दुनिया की हर खबर',
  logo: '/logo.svg',
  contactEmail: 'contact@gadgetglow.com',
  phone: '+91 98765 43210',
  address: 'प्रेस एवेन्यू, सेक्टर 17, चंडीगढ़ / नई दिल्ली, भारत - 160017',
  socialLinks: {
    facebook: 'https://facebook.com/gadgetglow',
    twitter: 'https://twitter.com/gadgetglow',
    youtube: 'https://youtube.com/@gadgetglow',
    instagram: 'https://instagram.com/gadgetglow',
    whatsapp: 'https://whatsapp.com/channel/gadgetglow',
    telegram: 'https://t.me/gadgetglow',
  },
  googleAnalyticsId: 'G-GADGETGLOW',
  facebookPixelId: 'FB-987654321',
  defaultSeoTitle: 'Gadget Glow - गैजेट, टेक और डिजिटल दुनिया की हर खबर | News Portal',
  defaultSeoDesc: 'गैजेट ग्लो पर पढ़ें टेक्नोलॉजी, स्मार्टफोन्स, गैजेट्स, देश, दुनिया, हरियाणा, राजनीति, अपराध और कारोबार की सबसे तेज व विश्वसनीय खबरें।',
  defaultSeoImage: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=1200&auto=format&fit=crop&q=80',
  copyrightText: '© 2026 Gadget Glow. सर्वाधिकार सुरक्षित (All Rights Reserved).',
  breakingNewsSpeed: 6,
...
export const INITIAL_HOMEPAGE_SECTIONS: HomepageSection[] = [
  ...
  { id: 'sec-newsletter', title: 'Newsletter', titleHi: 'गैजेट ग्लो ई-बुलेटिन', type: 'newsletter', limit: 1, order: 8, isEnabled: true },
];
...
export const INITIAL_SEO_SETTINGS: SeoSettings = {
  metaTitle: 'Gadget Glow - गैजेट, टेक और डिजिटल दुनिया की हर खबर | News Portal',
  metaDescription: 'गैजेट ग्लो पर पढ़ें टेक्नोलॉजी, स्मार्टफोन्स, गैजेट्स, देश, दुनिया, हरियाणा, राजनीति, अपराध और कारोबार की सबसे तेज व विश्वसनीय खबरें।',
  metaKeywords: 'Gadget Glow, गैजेट ग्लो, Tech News, Smartphones, Hindi News, Haryana News, Breaking News Hindi, Panipat News, Karnal News, Latest Khabar',
  googleAnalyticsId: 'G-GADGETGLOW',
  googleSearchConsoleVerification: 'google-site-verification=GG_DEMO_2026',
  googleNewsPublisherId: 'GG-NEWS-PUB-2026',
  robotsTxt: 'User-agent: *\nAllow: /\nDisallow: /admin/\nSitemap: https://gadgetglow.com/sitemap.xml',
  canonicalUrl: 'https://gadgetglow.com',
  canonicalDomain: 'https://gadgetglow.com',
  ogImage: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=1200&auto=format&fit=crop&q=80',
  twitterHandle: '@gadgetglow',
};
